...
type V0042Instance struct {
	...
	Time *V0042InstanceTime `json:"time,omitempty"`
}
...
func (o *V0042Instance) GetTime() V0042InstanceTime {
	if o == nil || o.Time == nil {
		var ret V0042InstanceTime
		return ret
	}
	return *o.Time
}
...
// and a boolean to check if the value has been set.
func (o *V0042Instance) GetTimeOk() (*V0042InstanceTime, bool) {
	if o == nil || o.Time == nil {
		return nil, false
	}
	return o.Time, true
...
// SetTime gets a reference to the given V0042InstanceTime and assigns it to the Time field.
func (o *V0042Instance) SetTime(v V0042InstanceTime) {
	o.Time = &v
}
