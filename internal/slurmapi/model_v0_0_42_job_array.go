...
type V0042JobArray struct {
	...
	Limits *V0042JobArrayLimits `json:"limits,omitempty"`
...
func (o *V0042JobArray) GetLimits() V0042JobArrayLimits {
	if o == nil || o.Limits == nil {
		var ret V0042JobArrayLimits
		return ret
	}
	return *o.Limits
}
...
// and a boolean to check if the value has been set.
func (o *V0042JobArray) GetLimitsOk() (*V0042JobArrayLimits, bool) {
	if o == nil || o.Limits == nil {
		return nil, false
	}
...
// SetLimits gets a reference to the given V0042JobArrayLimits and assigns it to the Limits field.
func (o *V0042JobArray) SetLimits(v V0042JobArrayLimits) {
	o.Limits = &v
}
