...
type V0042PartitionInfo struct {
	Nodes *V0042PartitionInfoNodes `json:"nodes,omitempty"`
	Accounts *V0042PartitionInfoAccounts `json:"accounts,omitempty"`
	Groups *V0042PartitionInfoGroups `json:"groups,omitempty"`
	Qos *V0042PartitionInfoQos `json:"qos,omitempty"`
	// Alternate
	Alternate *string `json:"alternate,omitempty"`
	Tres *V0042PartitionInfoTres `json:"tres,omitempty"`
	// Cluster name
	Cluster *string `json:"cluster,omitempty"`
	SelectType *[]string `json:"select_type,omitempty"`
	Cpus *V0042PartitionInfoCpus `json:"cpus,omitempty"`
	...
	Minimums *V0042PartitionInfoMinimums `json:"minimums,omitempty"`
	// PartitionName
	Name *string `json:"name,omitempty"`
	// NodeSets
	NodeSets *string `json:"node_sets,omitempty"`
	Priority *V0042PartitionInfoPriority `json:"priority,omitempty"`
...
func (o *V0042PartitionInfo) GetNodes() V0042PartitionInfoNodes {
	if o == nil || o.Nodes == nil {
		var ret V0042PartitionInfoNodes
		return ret
	}
	return *o.Nodes
}
...
func (o *V0042PartitionInfo) GetNodesOk() (*V0042PartitionInfoNodes, bool) {
	if o == nil || o.Nodes == nil {
		return nil, false
	}
	return o.Nodes, true
...
// SetNodes gets a reference to the given V0042PartitionInfoNodes and assigns it to the Nodes field.
func (o *V0042PartitionInfo) SetNodes(v V0042PartitionInfoNodes) {
	o.Nodes = &v
}

// GetAccounts returns the Accounts field value if set, zero value otherwise.
func (o *V0042PartitionInfo) GetAccounts() V0042PartitionInfoAccounts {
	if o == nil || o.Accounts == nil {
		var ret V0042PartitionInfoAccounts
		return ret
	}
	return *o.Accounts
}
...
// and a boolean to check if the value has been set.
func (o *V0042PartitionInfo) GetAccountsOk() (*V0042PartitionInfoAccounts, bool) {
	if o == nil || o.Accounts == nil {
		return nil, false
	}
...
// SetAccounts gets a reference to the given V0042PartitionInfoAccounts and assigns it to the Accounts field.
func (o *V0042PartitionInfo) SetAccounts(v V0042PartitionInfoAccounts) {
	o.Accounts = &v
}

// GetGroups returns the Groups field value if set, zero value otherwise.
func (o *V0042PartitionInfo) GetGroups() V0042PartitionInfoGroups {
	if o == nil || o.Groups == nil {
		var ret V0042PartitionInfoGroups
		return ret
	}
	return *o.Groups
}
...
// and a boolean to check if the value has been set.
func (o *V0042PartitionInfo) GetGroupsOk() (*V0042PartitionInfoGroups, bool) {
	if o == nil || o.Groups == nil {
		return nil, false
	}
...
// SetGroups gets a reference to the given V0042PartitionInfoGroups and assigns it to the Groups field.
func (o *V0042PartitionInfo) SetGroups(v V0042PartitionInfoGroups) {
	o.Groups = &v
}

// GetQos returns the Qos field value if set, zero value otherwise.
func (o *V0042PartitionInfo) GetQos() V0042PartitionInfoQos {
	if o == nil || o.Qos == nil {
		var ret V0042PartitionInfoQos
		return ret
	}
	return *o.Qos
}
...
// and a boolean to check if the value has been set.
func (o *V0042PartitionInfo) GetQosOk() (*V0042PartitionInfoQos, bool) {
	if o == nil || o.Qos == nil {
		return nil, false
	}
	return o.Qos, true
...
// SetQos gets a reference to the given V0042PartitionInfoQos and assigns it to the Qos field.
func (o *V0042PartitionInfo) SetQos(v V0042PartitionInfoQos) {
	o.Qos = &v
}
...
func (o *V0042PartitionInfo) GetTres() V0042PartitionInfoTres {
	if o == nil || o.Tres == nil {
		var ret V0042PartitionInfoTres
		return ret
	}
	return *o.Tres
}
...
// and a boolean to check if the value has been set.
func (o *V0042PartitionInfo) GetTresOk() (*V0042PartitionInfoTres, bool) {
	if o == nil || o.Tres == nil {
		return nil, false
	}
	return o.Tres, true
...
// SetTres gets a reference to the given V0042PartitionInfoTres and assigns it to the Tres field.
func (o *V0042PartitionInfo) SetTres(v V0042PartitionInfoTres) {
	o.Tres = &v
}
...
func (o *V0042PartitionInfo) GetCpus() V0042PartitionInfoCpus {
	if o == nil || o.Cpus == nil {
		var ret V0042PartitionInfoCpus
		return ret
	}
	return *o.Cpus
}
...
// and a boolean to check if the value has been set.
func (o *V0042PartitionInfo) GetCpusOk() (*V0042PartitionInfoCpus, bool) {
	if o == nil || o.Cpus == nil {
		return nil, false
	}
	return o.Cpus, true
...
// SetCpus gets a reference to the given V0042PartitionInfoCpus and assigns it to the Cpus field.
func (o *V0042PartitionInfo) SetCpus(v V0042PartitionInfoCpus) {
	o.Cpus = &v
}
...
func (o *V0042PartitionInfo) GetMinimums() V0042PartitionInfoMinimums {
	if o == nil || o.Minimums == nil {
		var ret V0042PartitionInfoMinimums
		return ret
	}
	return *o.Minimums
}
...
// and a boolean to check if the value has been set.
func (o *V0042PartitionInfo) GetMinimumsOk() (*V0042PartitionInfoMinimums, bool) {
	if o == nil || o.Minimums == nil {
		return nil, false
	}
...
// SetMinimums gets a reference to the given V0042PartitionInfoMinimums and assigns it to the Minimums field.
func (o *V0042PartitionInfo) SetMinimums(v V0042PartitionInfoMinimums) {
	o.Minimums = &v
}
...
func (o *V0042PartitionInfo) GetPriority() V0042PartitionInfoPriority {
	if o == nil || o.Priority == nil {
		var ret V0042PartitionInfoPriority
		return ret
	}
	return *o.Priority
}
...
// and a boolean to check if the value has been set.
func (o *V0042PartitionInfo) GetPriorityOk() (*V0042PartitionInfoPriority, bool) {
	if o == nil || o.Priority == nil {
		return nil, false
	}
...
// SetPriority gets a reference to the given V0042PartitionInfoPriority and assigns it to the Priority field.
func (o *V0042PartitionInfo) SetPriority(v V0042PartitionInfoPriority) {
	o.Priority = &v
}
