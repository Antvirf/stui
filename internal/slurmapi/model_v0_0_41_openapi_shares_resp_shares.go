...
type V0041OpenapiSharesRespShares struct {
	// Association shares
	Shares *[]V0041OpenapiSharesRespSharesShares1 `json:"shares,omitempty"`
...
func (o *V0041OpenapiSharesRespShares) GetShares() []V0041OpenapiSharesRespSharesShares1 {
	if o == nil || o.Shares == nil {
		var ret []V0041OpenapiSharesRespSharesShares1
		return ret
	}
	return *o.Shares
}
...
func (o *V0041OpenapiSharesRespShares) GetSharesOk() (*[]V0041OpenapiSharesRespSharesShares1, bool) {
	if o == nil || o.Shares == nil {
		return nil, false
	}
...
// SetShares gets a reference to the given []V0041OpenapiSharesRespSharesShares1 and assigns it to the Shares field.
func (o *V0041OpenapiSharesRespShares) SetShares(v []V0041OpenapiSharesRespSharesShares1) {
	o.Shares = &v
}
