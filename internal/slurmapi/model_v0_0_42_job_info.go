...
type V0042JobInfo struct {
	...
	Power *V0042JobInfoPower `json:"power,omitempty"`
...
func (o *V0042JobInfo) GetPower() V0042JobInfoPower {
	if o == nil || o.Power == nil {
		var ret V0042JobInfoPower
		return ret
	}
	return *o.Power
}
...
// and a boolean to check if the value has been set.
func (o *V0042JobInfo) GetPowerOk() (*V0042JobInfoPower, bool) {
	if o == nil || o.Power == nil {
		return nil, false
	}
	return o.Power, true
...
// SetPower gets a reference to the given V0042JobInfoPower and assigns it to the Power field.
func (o *V0042JobInfo) SetPower(v V0042JobInfoPower) {
	o.Power = &v
}
