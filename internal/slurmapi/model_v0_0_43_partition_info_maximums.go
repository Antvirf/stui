...
type V0043PartitionInfoMaximums struct {
	...
	Oversubscribe *V0043PartitionInfoMaximumsOversubscribe `json:"oversubscribe,omitempty"`
...
func (o *V0043PartitionInfoMaximums) GetOversubscribe() V0043PartitionInfoMaximumsOversubscribe {
	if o == nil || o.Oversubscribe == nil {
		var ret V0043PartitionInfoMaximumsOversubscribe
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V0043PartitionInfoMaximums) GetOversubscribeOk() (*V0043PartitionInfoMaximumsOversubscribe, bool) {
	if o == nil || o.Oversubscribe == nil {
		return nil, false
	}
...
// SetOversubscribe gets a reference to the given V0043PartitionInfoMaximumsOversubscribe and assigns it to the Oversubscribe field.
func (o *V0043PartitionInfoMaximums) SetOversubscribe(v V0043PartitionInfoMaximumsOversubscribe) {
	o.Oversubscribe = &v
}
