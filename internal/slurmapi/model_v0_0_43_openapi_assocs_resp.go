...
// V0043OpenapiAssocsResp struct for V0043OpenapiAssocsResp
type V0043OpenapiAssocsResp struct {
	Associations []V0043Assoc `json:"associations"`
...
func (o V0043OpenapiAssocsResp) MarshalJSON() ([]byte, error) {
...
type NullableV0043OpenapiAssocsResp struct {
	value *V0043OpenapiAssocsResp
	isSet bool
}

func (v NullableV0043OpenapiAssocsResp) Get() *V0043OpenapiAssocsResp {
	return v.value
}

func (v *NullableV0043OpenapiAssocsResp) Set(val *V0043OpenapiAssocsResp) {
	v.value = val
	v.isSet = true
}

func (v NullableV0043OpenapiAssocsResp) IsSet() bool {
	return v.isSet
}

func (v *NullableV0043OpenapiAssocsResp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0043OpenapiAssocsResp(val *V0043OpenapiAssocsResp) *NullableV0043OpenapiAssocsResp {
	return &NullableV0043OpenapiAssocsResp{value: val, isSet: true}
}

func (v NullableV0043OpenapiAssocsResp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0043OpenapiAssocsResp) UnmarshalJSON(src []byte) error {
	v.isSet = true
