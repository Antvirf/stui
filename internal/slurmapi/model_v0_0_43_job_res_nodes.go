...
// V0043JobResNodes struct for V0043JobResNodes
type V0043JobResNodes struct {
	...
	Allocation *[]V0043JobResNode `json:"allocation,omitempty"`
}
...
// SetAllocation gets a reference to the given []V0043JobResNode and assigns it to the Allocation field.
func (o *V0043JobResNodes) SetAllocation(v []V0043JobResNode) {
	o.Allocation = &v
}

func (o V0043JobResNodes) MarshalJSON() ([]byte, error) {
...
type NullableV0043JobResNodes struct {
	value *V0043JobResNodes
	isSet bool
}

func (v NullableV0043JobResNodes) Get() *V0043JobResNodes {
	return v.value
}

func (v *NullableV0043JobResNodes) Set(val *V0043JobResNodes) {
	v.value = val
	v.isSet = true
}

func (v NullableV0043JobResNodes) IsSet() bool {
	return v.isSet
}

func (v *NullableV0043JobResNodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0043JobResNodes(val *V0043JobResNodes) *NullableV0043JobResNodes {
	return &NullableV0043JobResNodes{value: val, isSet: true}
}

func (v NullableV0043JobResNodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0043JobResNodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
