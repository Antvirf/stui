...
type V0042CronEntry struct {
	...
	Line *V0042CronEntryLine `json:"line,omitempty"`
}
...
func (o *V0042CronEntry) GetLine() V0042CronEntryLine {
	if o == nil || o.Line == nil {
		var ret V0042CronEntryLine
		return ret
	}
	return *o.Line
}
...
// and a boolean to check if the value has been set.
func (o *V0042CronEntry) GetLineOk() (*V0042CronEntryLine, bool) {
	if o == nil || o.Line == nil {
		return nil, false
	}
	return o.Line, true
...
// SetLine gets a reference to the given V0042CronEntryLine and assigns it to the Line field.
func (o *V0042CronEntry) SetLine(v V0042CronEntryLine) {
	o.Line = &v
}
