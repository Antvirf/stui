...
type V0043User struct {
	...
	Default *V0043UserDefault `json:"default,omitempty"`
...
func (o *V0043User) GetDefault() V0043UserDefault {
	if o == nil || o.Default == nil {
		var ret V0043UserDefault
		return ret
	}
	return *o.Default
}
...
// and a boolean to check if the value has been set.
func (o *V0043User) GetDefaultOk() (*V0043UserDefault, bool) {
	if o == nil || o.Default == nil {
		return nil, false
	}
...
// SetDefault gets a reference to the given V0043UserDefault and assigns it to the Default field.
func (o *V0043User) SetDefault(v V0043UserDefault) {
	o.Default = &v
}
