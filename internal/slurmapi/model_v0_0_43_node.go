...
// V0043Node struct for V0043Node
type V0043Node struct {
	...
	CertFlags *[]string `json:"cert_flags,omitempty"`
...
// NewV0043Node instantiates a new V0043Node object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewV0043Node() *V0043Node {
	this := V0043Node{}
	return &this
}

// NewV0043NodeWithDefaults instantiates a new V0043Node object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewV0043NodeWithDefaults() *V0043Node {
	this := V0043Node{}
	return &this
}

// GetArchitecture returns the Architecture field value if set, zero value otherwise.
func (o *V0043Node) GetArchitecture() string {
...
func (o *V0043Node) GetArchitectureOk() (*string, bool) {
	if o == nil || o.Architecture == nil {
		return nil, false
	}
...
func (o *V0043Node) HasArchitecture() bool {
	if o != nil && o.Architecture != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetBurstbufferNetworkAddressOk() (*string, bool) {
	if o == nil || o.BurstbufferNetworkAddress == nil {
		return nil, false
	}
...
func (o *V0043Node) HasBurstbufferNetworkAddress() bool {
	if o != nil && o.BurstbufferNetworkAddress != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetBoardsOk() (*int32, bool) {
	if o == nil || o.Boards == nil {
		return nil, false
	}
...
func (o *V0043Node) HasBoards() bool {
	if o != nil && o.Boards != nil {
		return true
	}
...
func (o *V0043Node) SetBoards(v int32) {
	o.Boards = &v
}

// GetBootTime returns the BootTime field value if set, zero value otherwise.
func (o *V0043Node) GetBootTime() V0043Uint64NoValStruct {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetBootTimeOk() (*V0043Uint64NoValStruct, bool) {
	if o == nil || o.BootTime == nil {
		return nil, false
	}
...
func (o *V0043Node) HasBootTime() bool {
	if o != nil && o.BootTime != nil {
		return true
	}
...
// SetBootTime gets a reference to the given V0043Uint64NoValStruct and assigns it to the BootTime field.
func (o *V0043Node) SetBootTime(v V0043Uint64NoValStruct) {
	o.BootTime = &v
}

// GetTlsCertLastRenewal returns the TlsCertLastRenewal field value if set, zero value otherwise.
func (o *V0043Node) GetTlsCertLastRenewal() V0043Uint64NoValStruct {
	if o == nil || o.TlsCertLastRenewal == nil {
		var ret V0043Uint64NoValStruct
		return ret
	}
	return *o.TlsCertLastRenewal
}

// GetTlsCertLastRenewalOk returns a tuple with the TlsCertLastRenewal field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V0043Node) GetTlsCertLastRenewalOk() (*V0043Uint64NoValStruct, bool) {
	if o == nil || o.TlsCertLastRenewal == nil {
		return nil, false
	}
	return o.TlsCertLastRenewal, true
}

// HasTlsCertLastRenewal returns a boolean if a field has been set.
func (o *V0043Node) HasTlsCertLastRenewal() bool {
	if o != nil && o.TlsCertLastRenewal != nil {
		return true
	}
...
// SetTlsCertLastRenewal gets a reference to the given V0043Uint64NoValStruct and assigns it to the TlsCertLastRenewal field.
func (o *V0043Node) SetTlsCertLastRenewal(v V0043Uint64NoValStruct) {
	o.TlsCertLastRenewal = &v
}

// GetCertFlags returns the CertFlags field value if set, zero value otherwise.
func (o *V0043Node) GetCertFlags() []string {
	if o == nil || o.CertFlags == nil {
		var ret []string
		return ret
	}
	return *o.CertFlags
...
// GetCertFlagsOk returns a tuple with the CertFlags field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V0043Node) GetCertFlagsOk() (*[]string, bool) {
	if o == nil || o.CertFlags == nil {
		return nil, false
	}
	return o.CertFlags, true
}

// HasCertFlags returns a boolean if a field has been set.
func (o *V0043Node) HasCertFlags() bool {
	if o != nil && o.CertFlags != nil {
		return true
	}
...
// SetCertFlags gets a reference to the given []string and assigns it to the CertFlags field.
func (o *V0043Node) SetCertFlags(v []string) {
	o.CertFlags = &v
}

// GetClusterName returns the ClusterName field value if set, zero value otherwise.
func (o *V0043Node) GetClusterName() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetClusterNameOk() (*string, bool) {
	if o == nil || o.ClusterName == nil {
		return nil, false
	}
...
func (o *V0043Node) HasClusterName() bool {
	if o != nil && o.ClusterName != nil {
		return true
	}
...
func (o *V0043Node) SetClusterName(v string) {
	o.ClusterName = &v
}

// GetCores returns the Cores field value if set, zero value otherwise.
func (o *V0043Node) GetCores() int32 {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetCoresOk() (*int32, bool) {
	if o == nil || o.Cores == nil {
		return nil, false
	}
	return o.Cores, true
...
func (o *V0043Node) HasCores() bool {
	if o != nil && o.Cores != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetSpecializedCoresOk() (*int32, bool) {
	if o == nil || o.SpecializedCores == nil {
		return nil, false
	}
...
func (o *V0043Node) HasSpecializedCores() bool {
	if o != nil && o.SpecializedCores != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetCpuBindingOk() (*int32, bool) {
	if o == nil || o.CpuBinding == nil {
		return nil, false
	}
...
func (o *V0043Node) HasCpuBinding() bool {
	if o != nil && o.CpuBinding != nil {
		return true
	}
...
func (o *V0043Node) SetCpuBinding(v int32) {
	o.CpuBinding = &v
}

// GetCpuLoad returns the CpuLoad field value if set, zero value otherwise.
func (o *V0043Node) GetCpuLoad() int32 {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetCpuLoadOk() (*int32, bool) {
	if o == nil || o.CpuLoad == nil {
		return nil, false
	}
...
func (o *V0043Node) HasCpuLoad() bool {
	if o != nil && o.CpuLoad != nil {
		return true
	}
...
func (o *V0043Node) SetCpuLoad(v int32) {
	o.CpuLoad = &v
}

// GetFreeMem returns the FreeMem field value if set, zero value otherwise.
func (o *V0043Node) GetFreeMem() V0043Uint64NoValStruct {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetFreeMemOk() (*V0043Uint64NoValStruct, bool) {
	if o == nil || o.FreeMem == nil {
		return nil, false
	}
...
func (o *V0043Node) HasFreeMem() bool {
	if o != nil && o.FreeMem != nil {
		return true
	}
...
// SetFreeMem gets a reference to the given V0043Uint64NoValStruct and assigns it to the FreeMem field.
func (o *V0043Node) SetFreeMem(v V0043Uint64NoValStruct) {
	o.FreeMem = &v
}

// GetCpus returns the Cpus field value if set, zero value otherwise.
func (o *V0043Node) GetCpus() int32 {
	if o == nil || o.Cpus == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetCpusOk() (*int32, bool) {
	if o == nil || o.Cpus == nil {
		return nil, false
	}
	return o.Cpus, true
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetEffectiveCpusOk() (*int32, bool) {
	if o == nil || o.EffectiveCpus == nil {
		return nil, false
	}
...
func (o *V0043Node) HasEffectiveCpus() bool {
	if o != nil && o.EffectiveCpus != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetSpecializedCpusOk() (*string, bool) {
	if o == nil || o.SpecializedCpus == nil {
		return nil, false
	}
...
func (o *V0043Node) HasSpecializedCpus() bool {
	if o != nil && o.SpecializedCpus != nil {
		return true
	}
...
func (o *V0043Node) SetSpecializedCpus(v string) {
	o.SpecializedCpus = &v
}

// GetEnergy returns the Energy field value if set, zero value otherwise.
func (o *V0043Node) GetEnergy() V0043AcctGatherEnergy {
	if o == nil || o.Energy == nil {
		var ret V0043AcctGatherEnergy
		return ret
	}
	return *o.Energy
}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetEnergyOk() (*V0043AcctGatherEnergy, bool) {
	if o == nil || o.Energy == nil {
		return nil, false
	}
...
func (o *V0043Node) HasEnergy() bool {
	if o != nil && o.Energy != nil {
		return true
	}
...
// SetEnergy gets a reference to the given V0043AcctGatherEnergy and assigns it to the Energy field.
func (o *V0043Node) SetEnergy(v V0043AcctGatherEnergy) {
	o.Energy = &v
}

// GetExternalSensors returns the ExternalSensors field value if set, zero value otherwise.
// Deprecated
func (o *V0043Node) GetExternalSensors() map[string]interface{} {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *V0043Node) GetExternalSensorsOk() (*map[string]interface{}, bool) {
	if o == nil || o.ExternalSensors == nil {
		return nil, false
	}
...
func (o *V0043Node) HasExternalSensors() bool {
	if o != nil && o.ExternalSensors != nil {
		return true
	}
...
// Deprecated
func (o *V0043Node) SetExternalSensors(v map[string]interface{}) {
	o.ExternalSensors = &v
}

// GetExtra returns the Extra field value if set, zero value otherwise.
func (o *V0043Node) GetExtra() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetExtraOk() (*string, bool) {
	if o == nil || o.Extra == nil {
		return nil, false
	}
	return o.Extra, true
...
func (o *V0043Node) HasExtra() bool {
	if o != nil && o.Extra != nil {
		return true
	}
...
func (o *V0043Node) SetExtra(v string) {
	o.Extra = &v
}

// GetPower returns the Power field value if set, zero value otherwise.
// Deprecated
func (o *V0043Node) GetPower() map[string]interface{} {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *V0043Node) GetPowerOk() (*map[string]interface{}, bool) {
	if o == nil || o.Power == nil {
		return nil, false
	}
	return o.Power, true
...
func (o *V0043Node) HasPower() bool {
	if o != nil && o.Power != nil {
		return true
	}
...
// Deprecated
func (o *V0043Node) SetPower(v map[string]interface{}) {
	o.Power = &v
}

// GetFeatures returns the Features field value if set, zero value otherwise.
func (o *V0043Node) GetFeatures() []string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetFeaturesOk() (*[]string, bool) {
	if o == nil || o.Features == nil {
		return nil, false
	}
...
func (o *V0043Node) HasFeatures() bool {
	if o != nil && o.Features != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetActiveFeaturesOk() (*[]string, bool) {
	if o == nil || o.ActiveFeatures == nil {
		return nil, false
	}
...
func (o *V0043Node) HasActiveFeatures() bool {
	if o != nil && o.ActiveFeatures != nil {
		return true
	}
...
func (o *V0043Node) SetActiveFeatures(v []string) {
	o.ActiveFeatures = &v
}

// GetGpuSpec returns the GpuSpec field value if set, zero value otherwise.
func (o *V0043Node) GetGpuSpec() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetGpuSpecOk() (*string, bool) {
	if o == nil || o.GpuSpec == nil {
		return nil, false
	}
...
func (o *V0043Node) HasGpuSpec() bool {
	if o != nil && o.GpuSpec != nil {
		return true
	}
...
func (o *V0043Node) SetGpuSpec(v string) {
	o.GpuSpec = &v
}

// GetGres returns the Gres field value if set, zero value otherwise.
func (o *V0043Node) GetGres() string {
	if o == nil || o.Gres == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetGresOk() (*string, bool) {
	if o == nil || o.Gres == nil {
		return nil, false
	}
	return o.Gres, true
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetGresDrainedOk() (*string, bool) {
	if o == nil || o.GresDrained == nil {
		return nil, false
	}
...
func (o *V0043Node) HasGresDrained() bool {
	if o != nil && o.GresDrained != nil {
		return true
	}
...
func (o *V0043Node) SetGresDrained(v string) {
	o.GresDrained = &v
}

// GetGresUsed returns the GresUsed field value if set, zero value otherwise.
func (o *V0043Node) GetGresUsed() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetGresUsedOk() (*string, bool) {
	if o == nil || o.GresUsed == nil {
		return nil, false
	}
...
func (o *V0043Node) HasGresUsed() bool {
	if o != nil && o.GresUsed != nil {
		return true
	}
...
func (o *V0043Node) SetGresUsed(v string) {
	o.GresUsed = &v
}

// GetInstanceId returns the InstanceId field value if set, zero value otherwise.
func (o *V0043Node) GetInstanceId() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetInstanceIdOk() (*string, bool) {
	if o == nil || o.InstanceId == nil {
		return nil, false
	}
...
func (o *V0043Node) HasInstanceId() bool {
	if o != nil && o.InstanceId != nil {
		return true
	}
...
func (o *V0043Node) SetInstanceId(v string) {
	o.InstanceId = &v
}

// GetInstanceType returns the InstanceType field value if set, zero value otherwise.
func (o *V0043Node) GetInstanceType() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetInstanceTypeOk() (*string, bool) {
	if o == nil || o.InstanceType == nil {
		return nil, false
	}
...
func (o *V0043Node) HasInstanceType() bool {
	if o != nil && o.InstanceType != nil {
		return true
	}
...
func (o *V0043Node) SetInstanceType(v string) {
	o.InstanceType = &v
}

// GetLastBusy returns the LastBusy field value if set, zero value otherwise.
func (o *V0043Node) GetLastBusy() V0043Uint64NoValStruct {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetLastBusyOk() (*V0043Uint64NoValStruct, bool) {
	if o == nil || o.LastBusy == nil {
		return nil, false
	}
...
func (o *V0043Node) HasLastBusy() bool {
	if o != nil && o.LastBusy != nil {
		return true
	}
...
// SetLastBusy gets a reference to the given V0043Uint64NoValStruct and assigns it to the LastBusy field.
func (o *V0043Node) SetLastBusy(v V0043Uint64NoValStruct) {
	o.LastBusy = &v
}

// GetMcsLabel returns the McsLabel field value if set, zero value otherwise.
func (o *V0043Node) GetMcsLabel() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetMcsLabelOk() (*string, bool) {
	if o == nil || o.McsLabel == nil {
		return nil, false
	}
...
func (o *V0043Node) HasMcsLabel() bool {
	if o != nil && o.McsLabel != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetSpecializedMemoryOk() (*int64, bool) {
	if o == nil || o.SpecializedMemory == nil {
		return nil, false
	}
...
func (o *V0043Node) HasSpecializedMemory() bool {
	if o != nil && o.SpecializedMemory != nil {
		return true
	}
...
func (o *V0043Node) SetSpecializedMemory(v int64) {
	o.SpecializedMemory = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *V0043Node) GetName() string {
	if o == nil || o.Name == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetNameOk() (*string, bool) {
	if o == nil || o.Name == nil {
		return nil, false
	}
	return o.Name, true
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetNextStateAfterRebootOk() (*[]string, bool) {
	if o == nil || o.NextStateAfterReboot == nil {
		return nil, false
	}
...
func (o *V0043Node) HasNextStateAfterReboot() bool {
	if o != nil && o.NextStateAfterReboot != nil {
		return true
	}
...
func (o *V0043Node) SetNextStateAfterReboot(v []string) {
	o.NextStateAfterReboot = &v
}

// GetAddress returns the Address field value if set, zero value otherwise.
func (o *V0043Node) GetAddress() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetAddressOk() (*string, bool) {
	if o == nil || o.Address == nil {
		return nil, false
	}
...
func (o *V0043Node) HasAddress() bool {
	if o != nil && o.Address != nil {
		return true
	}
...
func (o *V0043Node) SetAddress(v string) {
	o.Address = &v
}

// GetHostname returns the Hostname field value if set, zero value otherwise.
func (o *V0043Node) GetHostname() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetHostnameOk() (*string, bool) {
	if o == nil || o.Hostname == nil {
		return nil, false
	}
...
func (o *V0043Node) HasHostname() bool {
	if o != nil && o.Hostname != nil {
		return true
	}
...
func (o *V0043Node) SetHostname(v string) {
	o.Hostname = &v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *V0043Node) GetState() []string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetStateOk() (*[]string, bool) {
	if o == nil || o.State == nil {
		return nil, false
	}
	return o.State, true
...
func (o *V0043Node) HasState() bool {
	if o != nil && o.State != nil {
		return true
	}
...
func (o *V0043Node) SetState(v []string) {
	o.State = &v
}

// GetOperatingSystem returns the OperatingSystem field value if set, zero value otherwise.
func (o *V0043Node) GetOperatingSystem() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetOperatingSystemOk() (*string, bool) {
	if o == nil || o.OperatingSystem == nil {
		return nil, false
	}
...
func (o *V0043Node) HasOperatingSystem() bool {
	if o != nil && o.OperatingSystem != nil {
		return true
	}
...
func (o *V0043Node) SetOperatingSystem(v string) {
	o.OperatingSystem = &v
}

// GetOwner returns the Owner field value if set, zero value otherwise.
func (o *V0043Node) GetOwner() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetOwnerOk() (*string, bool) {
	if o == nil || o.Owner == nil {
		return nil, false
	}
	return o.Owner, true
...
func (o *V0043Node) HasOwner() bool {
	if o != nil && o.Owner != nil {
		return true
	}
...
func (o *V0043Node) SetOwner(v string) {
	o.Owner = &v
}

// GetPartitions returns the Partitions field value if set, zero value otherwise.
func (o *V0043Node) GetPartitions() []string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetPartitionsOk() (*[]string, bool) {
	if o == nil || o.Partitions == nil {
		return nil, false
	}
...
func (o *V0043Node) HasPartitions() bool {
	if o != nil && o.Partitions != nil {
		return true
	}
...
func (o *V0043Node) SetPartitions(v []string) {
	o.Partitions = &v
}

// GetPort returns the Port field value if set, zero value otherwise.
func (o *V0043Node) GetPort() int32 {
	if o == nil || o.Port == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetPortOk() (*int32, bool) {
	if o == nil || o.Port == nil {
		return nil, false
	}
	return o.Port, true
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetRealMemoryOk() (*int64, bool) {
	if o == nil || o.RealMemory == nil {
		return nil, false
	}
...
func (o *V0043Node) HasRealMemory() bool {
	if o != nil && o.RealMemory != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetResCoresPerGpuOk() (*int32, bool) {
	if o == nil || o.ResCoresPerGpu == nil {
		return nil, false
	}
...
func (o *V0043Node) HasResCoresPerGpu() bool {
	if o != nil && o.ResCoresPerGpu != nil {
		return true
	}
...
func (o *V0043Node) SetResCoresPerGpu(v int32) {
	o.ResCoresPerGpu = &v
}

// GetComment returns the Comment field value if set, zero value otherwise.
func (o *V0043Node) GetComment() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetCommentOk() (*string, bool) {
	if o == nil || o.Comment == nil {
		return nil, false
	}
...
func (o *V0043Node) HasComment() bool {
	if o != nil && o.Comment != nil {
		return true
	}
...
func (o *V0043Node) SetComment(v string) {
	o.Comment = &v
}

// GetReason returns the Reason field value if set, zero value otherwise.
func (o *V0043Node) GetReason() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetReasonOk() (*string, bool) {
	if o == nil || o.Reason == nil {
		return nil, false
	}
...
func (o *V0043Node) HasReason() bool {
	if o != nil && o.Reason != nil {
		return true
	}
...
func (o *V0043Node) SetReason(v string) {
	o.Reason = &v
}

// GetReasonChangedAt returns the ReasonChangedAt field value if set, zero value otherwise.
func (o *V0043Node) GetReasonChangedAt() V0043Uint64NoValStruct {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetReasonChangedAtOk() (*V0043Uint64NoValStruct, bool) {
	if o == nil || o.ReasonChangedAt == nil {
		return nil, false
	}
...
func (o *V0043Node) HasReasonChangedAt() bool {
	if o != nil && o.ReasonChangedAt != nil {
		return true
	}
...
// SetReasonChangedAt gets a reference to the given V0043Uint64NoValStruct and assigns it to the ReasonChangedAt field.
func (o *V0043Node) SetReasonChangedAt(v V0043Uint64NoValStruct) {
	o.ReasonChangedAt = &v
}

// GetReasonSetByUser returns the ReasonSetByUser field value if set, zero value otherwise.
func (o *V0043Node) GetReasonSetByUser() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetReasonSetByUserOk() (*string, bool) {
	if o == nil || o.ReasonSetByUser == nil {
		return nil, false
	}
...
func (o *V0043Node) HasReasonSetByUser() bool {
	if o != nil && o.ReasonSetByUser != nil {
		return true
	}
...
func (o *V0043Node) SetReasonSetByUser(v string) {
	o.ReasonSetByUser = &v
}

// GetResumeAfter returns the ResumeAfter field value if set, zero value otherwise.
func (o *V0043Node) GetResumeAfter() V0043Uint64NoValStruct {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetResumeAfterOk() (*V0043Uint64NoValStruct, bool) {
	if o == nil || o.ResumeAfter == nil {
		return nil, false
	}
...
func (o *V0043Node) HasResumeAfter() bool {
	if o != nil && o.ResumeAfter != nil {
		return true
	}
...
// SetResumeAfter gets a reference to the given V0043Uint64NoValStruct and assigns it to the ResumeAfter field.
func (o *V0043Node) SetResumeAfter(v V0043Uint64NoValStruct) {
	o.ResumeAfter = &v
}

// GetReservation returns the Reservation field value if set, zero value otherwise.
func (o *V0043Node) GetReservation() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetReservationOk() (*string, bool) {
	if o == nil || o.Reservation == nil {
		return nil, false
	}
...
func (o *V0043Node) HasReservation() bool {
	if o != nil && o.Reservation != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetAllocMemoryOk() (*int64, bool) {
	if o == nil || o.AllocMemory == nil {
		return nil, false
	}
...
func (o *V0043Node) HasAllocMemory() bool {
	if o != nil && o.AllocMemory != nil {
		return true
	}
...
func (o *V0043Node) SetAllocMemory(v int64) {
	o.AllocMemory = &v
}

// GetAllocCpus returns the AllocCpus field value if set, zero value otherwise.
func (o *V0043Node) GetAllocCpus() int32 {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetAllocCpusOk() (*int32, bool) {
	if o == nil || o.AllocCpus == nil {
		return nil, false
	}
...
func (o *V0043Node) HasAllocCpus() bool {
	if o != nil && o.AllocCpus != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetAllocIdleCpusOk() (*int32, bool) {
	if o == nil || o.AllocIdleCpus == nil {
		return nil, false
	}
...
func (o *V0043Node) HasAllocIdleCpus() bool {
	if o != nil && o.AllocIdleCpus != nil {
		return true
	}
...
func (o *V0043Node) SetAllocIdleCpus(v int32) {
	o.AllocIdleCpus = &v
}

// GetTresUsed returns the TresUsed field value if set, zero value otherwise.
func (o *V0043Node) GetTresUsed() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetTresUsedOk() (*string, bool) {
	if o == nil || o.TresUsed == nil {
		return nil, false
	}
...
func (o *V0043Node) HasTresUsed() bool {
	if o != nil && o.TresUsed != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *V0043Node) GetTresWeightedOk() (*float64, bool) {
	if o == nil || o.TresWeighted == nil {
		return nil, false
	}
...
func (o *V0043Node) HasTresWeighted() bool {
	if o != nil && o.TresWeighted != nil {
		return true
	}
...
// Deprecated
func (o *V0043Node) SetTresWeighted(v float64) {
	o.TresWeighted = &v
}

// GetSlurmdStartTime returns the SlurmdStartTime field value if set, zero value otherwise.
func (o *V0043Node) GetSlurmdStartTime() V0043Uint64NoValStruct {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetSlurmdStartTimeOk() (*V0043Uint64NoValStruct, bool) {
	if o == nil || o.SlurmdStartTime == nil {
		return nil, false
	}
...
func (o *V0043Node) HasSlurmdStartTime() bool {
	if o != nil && o.SlurmdStartTime != nil {
		return true
	}
...
// SetSlurmdStartTime gets a reference to the given V0043Uint64NoValStruct and assigns it to the SlurmdStartTime field.
func (o *V0043Node) SetSlurmdStartTime(v V0043Uint64NoValStruct) {
	o.SlurmdStartTime = &v
}

// GetSockets returns the Sockets field value if set, zero value otherwise.
func (o *V0043Node) GetSockets() int32 {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetSocketsOk() (*int32, bool) {
	if o == nil || o.Sockets == nil {
		return nil, false
	}
...
func (o *V0043Node) HasSockets() bool {
	if o != nil && o.Sockets != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetThreadsOk() (*int32, bool) {
	if o == nil || o.Threads == nil {
		return nil, false
	}
...
func (o *V0043Node) HasThreads() bool {
	if o != nil && o.Threads != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetTemporaryDiskOk() (*int32, bool) {
	if o == nil || o.TemporaryDisk == nil {
		return nil, false
	}
...
func (o *V0043Node) HasTemporaryDisk() bool {
	if o != nil && o.TemporaryDisk != nil {
		return true
	}
...
func (o *V0043Node) SetTemporaryDisk(v int32) {
	o.TemporaryDisk = &v
}

// GetWeight returns the Weight field value if set, zero value otherwise.
func (o *V0043Node) GetWeight() int32 {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetWeightOk() (*int32, bool) {
	if o == nil || o.Weight == nil {
		return nil, false
	}
...
func (o *V0043Node) HasWeight() bool {
	if o != nil && o.Weight != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetTopologyOk() (*string, bool) {
	if o == nil || o.Topology == nil {
		return nil, false
	}
...
func (o *V0043Node) HasTopology() bool {
	if o != nil && o.Topology != nil {
		return true
	}
...
func (o *V0043Node) SetTopology(v string) {
	o.Topology = &v
}

// GetTres returns the Tres field value if set, zero value otherwise.
func (o *V0043Node) GetTres() string {
	if o == nil || o.Tres == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetTresOk() (*string, bool) {
	if o == nil || o.Tres == nil {
		return nil, false
	}
	return o.Tres, true
...
func (o *V0043Node) SetTres(v string) {
	o.Tres = &v
}

// GetVersion returns the Version field value if set, zero value otherwise.
func (o *V0043Node) GetVersion() string {
...
// and a boolean to check if the value has been set.
func (o *V0043Node) GetVersionOk() (*string, bool) {
	if o == nil || o.Version == nil {
		return nil, false
	}
...
func (o *V0043Node) HasVersion() bool {
	if o != nil && o.Version != nil {
		return true
	}
...
func (o *V0043Node) SetVersion(v string) {
	o.Version = &v
}

func (o V0043Node) MarshalJSON() ([]byte, error) {
	...
	if o.TlsCertLastRenewal != nil {
		toSerialize["tls_cert_last_renewal"] = o.TlsCertLastRenewal
	}
	if o.CertFlags != nil {
		toSerialize["cert_flags"] = o.CertFlags
	}
...
type NullableV0043Node struct {
	value *V0043Node
	isSet bool
}

func (v NullableV0043Node) Get() *V0043Node {
	return v.value
}

func (v *NullableV0043Node) Set(val *V0043Node) {
	v.value = val
	v.isSet = true
}

func (v NullableV0043Node) IsSet() bool {
	return v.isSet
}

func (v *NullableV0043Node) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0043Node(val *V0043Node) *NullableV0043Node {
	return &NullableV0043Node{value: val, isSet: true}
}

func (v NullableV0043Node) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0043Node) UnmarshalJSON(src []byte) error {
	v.isSet = true
